    ...
    <main className="flex-1 p-4 md:p-8 pb-20 max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-n-400">Seu build vai aparecer aqui</p>
        </div>
      </div>
      ...
      <Card>
        <CardContent className="pt-12 pb-12 text-center space-y-4">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-n-800 border border-n-700">
            <User className="h-10 w-10 text-accent-accent" />
          </div>
          <div className="space-y-2">
            ...
            <p className="text-n-400 max-w-sm mx-auto">
              Em breve: histórico de lições, conquistas, estatísticas detalhadas. Seu build vai brilhar aqui.
            </p>
          </div>
